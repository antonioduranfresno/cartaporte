...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<table id='tablaTiposMediosDurables' class='table table-hover table-striped table-condensed table-bordered'>
				...
				<c:forEach items="${listaTiposMediosDurables}" var="t" varStatus="index">
			
					<tr>
						<td>${t.timd_codigo}</td>
						<td>${t.timd_descripcion}</td>						
						<td style="text-align: center;"><a href="tipoMedioDurableForm?id=${t.id}" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td style="text-align: center;"><a href="#" onclick="eliminar(${t.id},'tipoMedioDurable');" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
	...
	function cargaDatos(){
		...
		$('#tablaTiposMediosDurables').DataTable({ 										
	    	"language": {
