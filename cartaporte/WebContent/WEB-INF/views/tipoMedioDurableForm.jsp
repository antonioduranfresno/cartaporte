...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="page-header">Tipo Medio Durable</h2>
                </div>                                
           </div> 
           
           <sf:form method="post" modelAttribute="tipoMedioDurable" >
					
				<sf:input type="hidden" path="id" value="${tipoMedioDurable.id}" />
				<sf:input type="hidden" path="agencia.id" value="${tipoMedioDurable.agencia.id}" />
			
			   	<div class="row">
		        	<div class="col-sm-4">
		        		<label>Código</label>
		        		<sf:errors path="timd_codigo" class="label label-danger"></sf:errors>
		        		<sf:input  path="timd_codigo" class="form-control" value="${tipoMedioDurable.timd_codigo}" maxlength="255" />		        		
		        	</div>				
				</div>
				...
				<div class="row">
		        	<div class="col-sm-9">
		        		...
		        		<sf:errors path="timd_descripcion" class="label label-danger"></sf:errors>
		        		<sf:input  path="timd_descripcion" class="form-control" value="${tipoMedioDurable.timd_descripcion}" maxlength="255" />		        		
		        	</div>
				</div>
				...
				<div class="footer">      
					...
					<div class="col-sm-10 derecha">			      		
			    		<input type="button" class="btn btn-danger" value="Eliminar"  onclick='eliminar($("#id").val(),"tipoMedioDurable");'>
			      	</div>      	
