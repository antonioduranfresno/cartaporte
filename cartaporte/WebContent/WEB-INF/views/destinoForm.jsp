...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <sf:form method="post" modelAttribute="destino" >
					
				<sf:input type="hidden" path="id" value="${destino.id}" />
				...
				<div class="footer">      
					...
					<div class="col-sm-10 derecha">			      		
			    		<input type="button" class="btn btn-danger" value="Eliminar"  onclick='eliminar($("#id").val(),"destino");'>
			      	</div>      	
